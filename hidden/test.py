...
async def test_7seg(dut):
    ...
    assert dut.uo_out == 0b11111100

    dut.uio_in.value = 2
    assert dut.uo_out == 117
    ...
    dut.uio_in.value = 4
    dut.ui_in.value = 0b10011011
    assert dut.uo_out == 0b1001

    dut.uio_in.value = 5
    assert dut.uo_out == 0b1101


    dut.uio_in.value = 6
    assert dut.uo_out == 0b0100

    dut.uio_in.value = 7
    assert dut.uo_out == 0b0110

    dut.uio_in.value = 8
    assert dut.uo_out == 0b0010

    dut.uio_in.value = 9
    assert dut.uo_out == 0b01000110
